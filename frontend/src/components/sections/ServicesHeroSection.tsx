    ...
    <section className="relative overflow-hidden">
      ...
      <div className="container-content py-20 lg:py-24">
        <div className="flex flex-col items-center text-center max-w-3xl mx-auto">
          ...
          <p className="mt-4 text-[15px] md:text-base text-white/85 leading-relaxed max-w-2xl">
            As a comprehensive logistics company, we offer a variety of delivery
            services according to your requirements — from Instant Local
            Delivery to International Cargo and Courier.
          </p>
        </div>
      </div>
    </section>
